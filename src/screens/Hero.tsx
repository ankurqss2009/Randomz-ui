  ...
  return (
    <div className="flex justify-start md:p-20 p-10 z-10 items-center h-full">
      <div className="flex flex-col text-white z-10 h-full justify-center">
        ...
        <div className="grid grid-cols-2  gap-4 w-full mt-6 md:max-w-sm">
          <div>
            <Link
              to="/signup"
          ...
          <div>
            <Link
              to="/login"
              className="leading-4 justify-center flex items-center  p-3 text-center rounded-md bg-[#C0317C]  text-white font-bold"
            >
              Sign in
              <span className="ml-2">
                <svg
