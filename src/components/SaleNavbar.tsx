          ...
          {({ open }) => (
            <>
              <div className="flex justify-between z-10">
                ...
                <div
                  className={`flex md:hidden p-4 h-full items-center justify-between w-full md:w-auto  ${open ? " bg-black " : " bg-transparent "
                    } `}
                >
                  <Link to={"/"}>
                    <img
                  ...
                  <div className="grid grid-cols-1 gap-4 z-10">
                    ...
                    {!localStorage.getItem("token") ? (
                      ...
                      <>
                        <button
                          onClick={handleLogout}
                          className="flex justify-center items-center p-2 text-center rounded-md  bg-[#1C2129] text-white"
                        >
                          Logout
                          <svg
                            className="ml-4"
                        ...
                        <Link className=" justify-center  items-center text-center rounded-md  text-white " to="/aboutUs">
                          About Us
                        </Link>
                        <Link className=" justify-center  items-center text-center rounded-md  text-white " to="/">
                          Litepaper
                        </Link>
                      </>
